/*   include/spede/machine/debug_reg.h
 *	@(#)debug_reg.h	1.3   12/30/99
 */
/* 
...
#define DR7_LG0 	(DR7_L0|DR7_G0)
#define DR7_LG1 	(DR7_L1|DR7_G1)
#define DR7_LG2 	(DR7_L2|DR7_G2)
#define DR7_LG3 	(DR7_L3|DR7_G3)
...
#define set_dr0(val)	asm volatile("movl %0,%%dr0" : : "r" (val))
#define set_dr1(val)	asm volatile("movl %0,%%dr1" : : "r" (val))
#define set_dr2(val)	asm volatile("movl %0,%%dr2" : : "r" (val))
#define set_dr3(val)	asm volatile("movl %0,%%dr3" : : "r" (val))
#define set_dr6(val)	asm volatile("movl %0,%%dr6" : : "r" (val))
#define set_dr7(val)	asm volatile("movl %0,%%dr7" : : "r" (val))
...
extern unsigned		get_dr0();
extern unsigned		get_dr1();
extern unsigned		get_dr2();
extern unsigned		get_dr3();
extern unsigned		get_dr6();
extern unsigned		get_dr7();

extern void		set_b0(unsigned addr, unsigned len, unsigned rw);
extern void		set_b1(unsigned addr, unsigned len, unsigned rw);
extern void		set_b2(unsigned addr, unsigned len, unsigned rw);
extern void		set_b3(unsigned addr, unsigned len, unsigned rw);

#endif	/* else __OPTIMIZE__ */
