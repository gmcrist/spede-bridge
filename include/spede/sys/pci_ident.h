/*   include/spede/sys/pci_ident.h
 *	Vendor and Device identifiers for PCI.
 *	@(#)pci_ident.h	1.2   02/01/00
 */

/**
 *	(From Linux kernel 2.3.19 linux/include/linux/pci.h)
 *	(Moved vendor/device ID's to own file, Nov 1999, bwitt)
 */

#ifndef _INC_SPEDE_SYS_PCI_IDENT_H
#define _INC_SPEDE_SYS_PCI_IDENT_H
